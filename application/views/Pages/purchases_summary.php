    ...
    <div class="col-12">
        <div class="form-hero">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2><i class="ph ph-wallet mr-2"></i>Purchases Summary</h2>
...
<div class="row">
    <div class="col-12">
        <div class="card table-card">
            <div class="card-header">
                <h5><span class="section-icon"><i class="ph ph-file-doc"></i></span>Purchase Report</h5>
            </div>
            <div class="card-body">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="no-data" style="border: none;">
                                            <i class="ph ph-wallet mb-3 d-block" style="font-size: 48px;"></i>

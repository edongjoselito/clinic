                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            ...
                                            echo form_open('Pages/appointment_edit/'.$edit_app->id, $attributes);
                                        ?>

                                        <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <input type="hidden" name="p_id" value="<?= $data->id; ?>">
                                                    <input type="hidden" name="a_id" value="<?= $this->uri->segment(4); ?>">
                                        ...
                                        <div class="mt-3">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" onclick="refer()" id="customRadio1" name="ref" value="0" <?php if($edit_app->referral_status == 0){echo "checked";} ?> class="custom-control-input"/>
                                                        <label class="custom-control-label text-xs" for="customRadio1">Walk In</label>
                                                    </div>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" onclick="referral()" id="customRadio2" name="ref" value="1" <?php if($edit_app->referral_status == 1){echo "checked";} ?> class="custom-control-input" />
                                        ...
                                        <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required class="form-control" name="bp" value="<?= $edit_app->bp; ?>" placeholder="Blood Presure" />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputUsername" class="col-form-label">Weight</label>
                                                    <input type="text" required class="form-control" name="weight" value="<?= $edit_app->weight; ?>" placeholder="Weight" />
                                                </div>
                                        </div>

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <input type='text' required class='form-control' name='lmp' value="<?= $edit_app->lmp; ?>" id='datepic1' readonly placeholder="LMP">
                                            </div> 
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" id=esDate name="date_of_delivery" value="<?= $edit_app->date_of_delivery; ?>" class='form-control' readonly  required />
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="inputUsername" class="col-form-label">Gravida</label>
                                            <input required type="text" name="gravida" value="<?= $edit_app->gravida; ?>" class='form-control' required />
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="inputUsername" class="col-form-label">Parity</label>
                                            <input required type="text" name="parity" class='form-control' value="<?= $edit_app->parity; ?>" required />
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="inputUsername" class="col-form-label">Term</label>
                                            <input required type="text" name="term" class='form-control' value="<?= $edit_app->term; ?>" required />
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="inputUsername" class="col-form-label">Preterm</label>
                                            <input required type="text" name="preterm" class='form-control' value="<?= $edit_app->preterm; ?>" required />
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="inputUsername" class="col-form-label">Abortion</label>
                                            <input required type="text" name="abortion" value="<?= $edit_app->abortion; ?>" class='form-control' required />
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label for="inputUsername" class="col-form-label">Living</label>
                                            <input required type="text" name="living" value="<?= $edit_app->living; ?>" class='form-control' required />
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <textarea class="form-control" rows="5" id="example-textarea" name="transaction" placeholder="Transaction"><?= $edit_app->transaction; ?></textarea>   
                                        </div>
                                    </div>  
                                        ...
                                        <div class="form-group">
                                                    <input type="submit" name="submit" value="Update Appointment" class="btn btn-primary waves-effect waves-light mr-1" />

...
<div class="card" style="border: none; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); margin-bottom: 25px;">
    ...
    <div class="card-body" style="padding: 25px;">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label style="font-weight: 500; color: #424242; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;">LMP</label>
                <input type='text' required class='form-control' name='lmp' id='datepic1' readonly placeholder="LMP" style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;">
            </div> 
            ...
            <div class="form-group col-md-6">
                ...
                <div>
                    <input type=button class="btn btn-primary" value='Calculate' onclick=calculate() style="background: linear-gradient(135deg, #1e88e5 0%, #1565c0 100%); border: none; color: white; padding: 12px 25px; border-radius: 8px; font-weight: 500;">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" id=esDate name="date_of_delivery" class='form-control' readonly required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px; background-color: #f5f5f5;" />
            </div>
            <div class="form-group col-md-1">
                ...
                <input required type="text" name="gravida" class='form-control' required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" />
            </div>
            <div class="form-group col-md-1">
                ...
                <input required type="text" name="parity" class='form-control' required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" />
            </div>
            <div class="form-group col-md-1">
                ...
                <input required type="text" name="term" class='form-control' required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" />
            </div>
            <div class="form-group col-md-1">
                ...
                <input required type="text" name="preterm" class='form-control' required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" />
            </div>
            <div class="form-group col-md-1">
                ...
                <input required type="text" name="abortion" class='form-control' required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" />
            </div>
            <div class="form-group col-md-1">
                ...
                <input required type="text" name="living" class='form-control' required style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" />
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <select required class="form-control" id="company" style="display:none; margin-top:10px; border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px;" type="text" name="ref_id">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <textarea class="form-control" rows="5" id="example-textarea" name="transaction" placeholder="Enter transaction details..." style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 12px 15px; font-size: 14px; resize: vertical;"></textarea>   
            </div>
        </div>  

...
<div class="row">
    ...
    <div class="row align-items-center">
        <div class="col-md-8">
            <h2><i class="mdi mdi-chart-bar mr-2"></i>Expenses Summary</h2>
            <p>Generate expense reports by date range</p>
        </div>
...
<div class="row">
    ...
    <div class="card-header">
        <h5><span class="section-icon"><i class="mdi mdi-file-document-outline"></i></span>Expense Report</h5>
    </div>
    <div class="card-body">
        <?php if(!isset($_POST['submit'])): ?>
            ...
            <div class="no-data">
                ...
                <p>Select a date range and click Generate Report to view expenses</p>
            </div>
        ...
        <?php else: ?>
            ...
            <div class="alert alert-info mb-4" style="background: rgba(30, 136, 229, 0.1); border: none; color: #1565c0; border-radius: 8px;">
                ...
                Report period: <strong><?= date('F d, Y', strtotime($df)); ?></strong> to <strong><?= date('F d, Y', strtotime($dt)); ?></strong>
            </div>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="no-data" style="border: none;">
                                    <i class="mdi mdi-file-document-outline mdi-48px mb-3 d-block"></i>

...
<div class="row">
    ...
    <div class="row align-items-center">
        <div class="col-md-8">
            <h2><i class="ph ph-chart-line mr-2"></i>Expenses Summary</h2>
...
<div class="row">
    ...
    <div class="card-header">
        <h5><span class="section-icon"><i class="ph ph-file-doc"></i></span>Expense Report</h5>
    </div>
    <div class="card-body">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="4" class="no-data" style="border: none;">
                                    <i class="ph ph-file-doc mb-3 d-block" style="font-size: 48px;"></i>

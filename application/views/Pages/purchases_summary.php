...
<div class="purchases-summary-wrapper">
    ...
    <div class="col-12">
        <div class="form-hero">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2><i class="mdi mdi-cart mr-2"></i>Purchases Summary</h2>
                    <p>Generate purchase reports by date range</p>
                </div>
...
<div class="row">
    <div class="col-12">
        <div class="card table-card">
            <div class="card-header">
                <h5><span class="section-icon"><i class="mdi mdi-file-document-outline"></i></span>Purchase Report</h5>
            </div>
            <div class="card-body">
                <?php if(!isset($_POST['submit'])): ?>
                    ...
                    <div class="no-data">
                        ...
                        <p>Select a date range and click Generate Report to view purchases</p>
                    </div>
                ...
                <?php else: ?>
                        ...
                        <table class="table table-modern">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row->quantity; ?></td>
                                    <td class="text-right font-weight-bold">PHP <?= number_format($row->total, 2); ?></td>
                                </tr>
                                <?php $total += $row->total; ?>
                                <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="no-data" style="border: none;">
                                            <i class="mdi mdi-cart-off mdi-48px mb-3 d-block"></i>
                    ...
                    <div class="total-box">
                        <h3>Total Purchases Summary</h3>
                        <div class="total-amount">PHP <?= number_format($total, 2); ?></div>
                    </div>
                    <?php endif; ?>

                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required value="<?= set_value('mname'); ?>" name="mname" class="form-control">
                                                </div>
                                        </div>
                                        <div class="form-row">
                                                <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputClinic" class="col-form-label">Assign to Clinic <span class="text-danger">*</span></label>

...
<div class="mhero">
    <div class="mhero-inner">
        <div>
            <h2><i class="ph ph-shopping-bag-open"></i>Purchases Summary</h2>
            <p>Stock-in and supply purchases by date range</p>
        </div>
        <div class="hero-right">
            ...
            <div class="hero-stat">
                ...
                <div>
                    <div class="stat-count"><?= number_format($totalQty); ?></div>
                    <div class="stat-label">Units In</div>
                </div>
            </div>
            <?php endif; ?>
...
<div class="card data-card">
    <div class="card-header">
        <h5><i class="ph ph-file-doc"></i>Purchase Report <?= $filtered ? '<span class="count-badge">' . number_format(count($rows)) . '</span>' : ''; ?></h5>
        <?php if($filtered): ?>
    ...
    <div class="card-body">
        <?php if(!$filtered): ?>
            <div class="empty-state">
                ...
                <span>Choose a date range to see stock purchases.</span><br>
        ...
        <?php elseif(empty($rows)): ?>
            <div class="empty-state">
                ...
                <span>No stock-ins recorded between <?= date('M d', strtotime($df)); ?> and <?= date('M d, Y', strtotime($dt)); ?>.</span><br>
            ...
            <table class="table table-modern">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><div class="cell-main"><?= $row->item_name ? htmlentities($row->item_name) : '<span class="cell-sub">Item #' . (int) $row->item_id . '</span>'; ?></div></td>
                ...
                <tfoot>
                    <tr>
                        <td colspan="3">Totals &middot; <?= number_format(count($rows)); ?> record<?= count($rows) !== 1 ? 's' : ''; ?></td>
...
<div id="filterModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <?= form_open('Pages/purchases_summary/'); ?>

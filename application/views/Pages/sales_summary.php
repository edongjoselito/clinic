    ...
    <div class="col-12">
        <div class="form-hero">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2><i class="mdi mdi-cash-register mr-2"></i>Sales Summary</h2>
...
<div class="row">
    <div class="col-12">
        <div class="card table-card">
            <div class="card-header">
                <h5><span class="section-icon"><i class="mdi mdi-file-document-outline"></i></span>Sales Report</h5>
            </div>
            <div class="card-body">
                <?php if(!isset($_POST['submit'])): ?>
                    ...
                    <div class="no-data">
                        ...
                        <p>Select a date range and click Generate Report to view sales</p>
                    </div>
                        ...
                        <table class="table table-modern">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">PHP <?= number_format($row->total_retail, 2); ?></td>
                                    <td class="text-right text-danger">- PHP <?= number_format($row->discount, 2); ?></td>
                                    <td class="text-right font-weight-bold">PHP <?= number_format($row->amount_due, 2); ?></td>
                                </tr>
                                <?php $totalAmount += $row->amount_due; ?>
                                <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="no-data" style="border: none;">
                                            <i class="mdi mdi-cash-off mdi-48px mb-3 d-block"></i>

    ...
    <div class="col-12">
        <div class="card table-card">
            <div class="card-header">
                <h5><span class="section-icon"><i class="ph ph-file-doc"></i></span>Expense Records</h5>
            </div>
            <div class="card-body">
